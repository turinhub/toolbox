    ...
    <div className={cn("h-full w-full", className)}>
      <Card className={cn("relative h-full w-full pt-4", className)}>
        ...
        >
          ...
          <TabsContent
            className="h-full min-h-0 flex-grow px-2"
            value="report"
            forceMount
            hidden={activeTab !== "report"}
          >
            <ErrorBoundary fallback={<div className="flex h-full items-center justify-center p-4"><span className="text-muted-foreground">Report loading...</span></div>}>
              <ScrollContainer
          ...
          >
            <ErrorBoundary fallback={<div className="flex h-full items-center justify-center p-4"><span className="text-muted-foreground">Activities loading...</span></div>}>
              <ScrollContainer
                className="h-full"
                scrollShadowColor="var(--card)"
                autoScrollToBottom={!hasReport || reportStreaming}
