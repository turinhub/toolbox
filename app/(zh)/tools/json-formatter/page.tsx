      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-muted rounded-lg">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs sm:text-sm">{t("indentSize")}</span>
              <Tabs
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-center">
                <div className="text-sm font-medium">{t("inputTitle")}</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-center">
                <div className="text-sm font-medium">{t("outputTitle")}</div>
                <div className="flex gap-2">
                  <Tabs
                    value={viewMode}
              ...
              <div className="min-h-[400px] p-4 border rounded-md bg-muted/50">
                {viewMode === "tree" && parsedData !== null ? (
                  ...
                  <div className="text-muted-foreground text-center py-20">
                    {jsonError ? t("emptyError") : t("emptyPreview")}
                  </div>
                )}
              </div>
            </div>
