    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
            ...
            <div>
              <div className="mb-6 flex flex-wrap items-center gap-2">
                <span className="rounded-md border bg-background px-2.5 py-1 font-mono text-xs uppercase tracking-[0.18em] text-muted-foreground">
                  {messages.home.badgeLocalFirst}
                </span>
                <span className="rounded-md border bg-background px-2.5 py-1 font-mono text-xs uppercase tracking-[0.18em] text-muted-foreground">
                  {messages.home.badgeNoAds}
                </span>
              </div>
        ...
        <div className="mb-4 flex items-end justify-between gap-4">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.18em] text-muted-foreground">
              {messages.home.indexEyebrow}
            </p>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight">
              {messages.home.indexTitle}
            </h2>
          </div>
          <Link
            href={localizePath("/tools", locale)}
      ...
      <section className="border-t py-8">
        <div className="grid gap-4 md:grid-cols-[0.35fr_0.65fr]">
          <h2 className="text-xl font-semibold">{messages.home.aboutTitle}</h2>
          <div>
